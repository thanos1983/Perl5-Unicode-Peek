# This Makefile is for the Unicode::Peek extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Unicode/Peek.pm]
#     AUTHOR => [q[Thanos <tinyos@>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     NAME => q[Unicode::Peek]
#     PREREQ_PM => {  }
...
MAN3EXT = 3pm
INSTALLDIRS = site
INSTALL_BASE = /home/tinyos/perl5
DESTDIR = 
PREFIX = $(INSTALL_BASE)
...
MAKE = make
FULLEXT = Unicode/Peek
BASEEXT = Peek
PARENT_NAME = Unicode
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Unicode/Peek.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Unicode/Peek.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIBDEP)$(DFSEP)Config.pm $(PERL_INCDEP)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Unicode
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Unicode
...
TO_INST_PM = lib/Unicode/Peek.pm \
	pod.pl
...
manifypods : pure_all config  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) -u \
	  lib/Unicode/Peek.pm $(INST_MAN3DIR)/Unicode::Peek.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'generated_by: '\''ExtUtils::MakeMaker version 7.3, CPAN::Meta::Converter version 2.150010'\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'license: unknown' >> META_new.yml
	$(NOECHO) $(ECHO) 'meta-spec:' >> META_new.yml
	$(NOECHO) $(ECHO) '  url: http://module-build.sourceforge.net/META-spec-v1.4.html' >> META_new.yml
	$(NOECHO) $(ECHO) '  version: '\''1.4'\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'name: Unicode-Peek' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "generated_by" : "ExtUtils::MakeMaker version 7.3, CPAN::Meta::Converter version 2.150010",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Unicode-Peek",' >> META_new.json
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="Unicode-Peek" VERSION="0.02">' > Unicode-Peek.ppd
	...
	$(NOECHO) $(ECHO) '        <CODEBASE HREF="" />' >> Unicode-Peek.ppd
	$(NOECHO) $(ECHO) '    </IMPLEMENTATION>' >> Unicode-Peek.ppd
	$(NOECHO) $(ECHO) '</SOFTPKG>' >> Unicode-Peek.ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  'lib/Unicode/Peek.pm' 'blib/lib/Unicode/Peek.pm' \
	  'pod.pl' '$(INST_LIB)/Unicode/pod.pl' 
